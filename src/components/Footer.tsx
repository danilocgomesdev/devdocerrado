...
import Logoligth from "../assets/logoDescricao.svg";
import Logodark from "../assets/logoDescricaolight.svg";

const Logo = (props: any) => {
  return (
    <svg height={28} viewBox="0 0 120 28" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
      ...
      <Container as={Stack} maxW={"6xl"} py={10}>
        <SimpleGrid templateColumns={{ sm: "1fr 1fr", md: "2fr 1fr 1fr 2fr" }} spacing={8}>
          <Stack spacing={6}>
            <Box>
              {colorMode === "dark" ? (
                <Image src={Logodark} width={150} alt="Picture of the author" color="white" />
              ) : (
                <Image src={Logoligth} width={150} alt="Picture of the author" color="white" />
              )}
            </Box>
