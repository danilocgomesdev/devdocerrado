        ...
        <Container maxW={"7xl"}>
          ...
          >
            <Stack flex={1} spacing={{ base: 5, md: 10 }}>
              ...
              <Text color={"gray.500"}>
                Snippy é um aplicativo rico de trechos de código que permite criar seus próprios
                trechos de código, categorizá-los e até mesmo sincronizá-los na nuvem para que você
                possa usá-los em qualquer lugar. Tudo isso é grátis!
              </Text>
